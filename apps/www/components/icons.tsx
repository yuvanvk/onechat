...
export const Favourite = () => (
  <svg
    ...
    className="lucide lucide-star size-5 text-muted-foreground transition-colors group-hover:text-foreground"
    aria-hidden="true"
  >
...
export const Anthropic = ({ size = 20, ...props }: IconProps) => (
  <svg
    {...props}
    width={size}
    height={size}
...
export const OpenAI = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} preserveAspectRatio="xMidYMid" viewBox="0 0 256 260">
...
export const Gemini = ({ size = 20, ...props }: IconProps) => (

  <svg {...props} width={size} height={size} viewBox="0 0 296 298" fill="none">
    <mask
      id="gemini__a"
      width="296"
      height="298"
...
export const Meta = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} preserveAspectRatio="xMidYMid" viewBox="0 0 256 171">
    <defs>
...
export const MistralAI = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} preserveAspectRatio="xMidYMid" viewBox="0 0 256 233">
...
export const Qwen = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} fill="#ffff" fillRule="evenodd" style={{ flex: "none", lineHeight: "1" }} viewBox="0 0 24 24">
    <title>Qwen</title>
...
export const xAI = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} xmlSpace="preserve" fill="#ffff" viewBox="0 0 841.89 595.28">
...
export const DeepSeek = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} style={{ flex: "none", lineHeight: "1" }} viewBox="0 0 24 24">
...
export const Kimi = ({ size = 20, ...props }: IconProps) => (
  <svg {...props} width={size} height={size} viewBox="0 0 512 512" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2">
